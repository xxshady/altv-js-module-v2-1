...
// clang-format off
js::Module compatibilityModule("alt-client", [](js::IResource* resource) -> v8::Local<v8::Object> { return resource->GetCompatibilityModuleNamespace(); }, js::Module::Option::COMPATIBILITY_MODULE | js::Module::Option::EXPORT_AS_DEFAULT);
...
js::Module compatibilityNativesModule("natives", [](js::ModuleTemplate& tpl) {
